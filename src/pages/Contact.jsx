      ...
      <div className='flex justify-between gap-5 mx-auto w-[75%] max-lg:flex-col mb-24 relative'>
        ...
        <div className='relative w-[45%] max-lg:w-full z-[2]'>
          ...
          <div >
            ...
            <input className='p-[13px] py-[15px] w-full focus:outline-none bg-[#E9E9E9]' type="text" placeholder='EG: "John doe"' />
          </div>

          <div>
            <h1 className='font-[600] py-5 text-[18px]'>Email</h1>
            <input className='p-[13px] py-[15px] w-full focus:outline-none bg-[#E9E9E9]' type="text" placeholder='EG: "johndoe@gmail.com"' />
          </div>
          <div>
            <h1 className='font-[600] py-5 text-[18px]'>Enter some thing or i will kill you :)</h1>
