    ...
    <div className='bg-white w-[100%] mx-auto rounded-xl shadow-md'>
      ...
      <div className='p-5 px-6 flex flex-col gap-3'>
        <span className='flex justify-between items-center'>
          ...
          <span className='font-[700] text-[16px]'> {modelP} <span className='font-[400] text-[16px]'></span> </span>
        </span>
        ...
        <button className='py-4 font-[600] hover:bg-accent text-[20px] text-white rounded-md bg-[#fc6e58]'>Book Now</button>
      </div>
    </div>
  )
}
