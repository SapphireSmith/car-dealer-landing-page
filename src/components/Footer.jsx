...
function Footer() {
  ...
  return (
    <div className='bg-white flex justify-between gap-5 max-lg:grid max-md:block px-[67px] max-sm:px-[30px]  md-lg:grid-cols-2 py-10 relative z-[5]'>
      <div className='w-3/12 max-lg:w-full max-lg:text-center flex gap-3 flex-col justify-between'>
        <h1 className='text-xl'> <span className='font-[600]'>CAR</span> Deals</h1>
        ...
        <span className='flex gap-4 items-center font-[500] mt-4 max-lg:mx-auto'><BsFillTelephoneFill /> <span className='font-[500]'>+011552876342</span> </span>
        <span className='flex gap-4 items-center font-[500] max-lg:mx-auto'><ImMail3 /> <span className='font-5600]'>Cardeals@gmail.com</span> </span>
      </div>
